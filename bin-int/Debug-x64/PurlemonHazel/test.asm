...
__341D8A77_bit DB 01H
__DBB70CA8_compare DB 01H
...
__67B3BC78_test@h DB 01H
__565E8CC1_test@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	?Print@PurlemonHazel@@YAXXZ			; PurlemonHazel::Print
...
PUBLIC	??_C@_0BK@CEIHGBBI@Welcome?5to?5PurlemonHazel?$CB@ ; `string'
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?Print@PurlemonHazel@@YAXXZ DD imagerel $LN3
	DD	imagerel $LN3+83
	DD	imagerel $unwind$?Print@PurlemonHazel@@YAXXZ
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0BK@CEIHGBBI@Welcome?5to?5PurlemonHazel?$CB@
CONST	SEGMENT
??_C@_0BK@CEIHGBBI@Welcome?5to?5PurlemonHazel?$CB@ DB 'Welcome to Purlemo'
	DB	'nHazel!', 00H				; `string'
CONST	ENDS
;	COMDAT xdata
xdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?Print@PurlemonHazel@@YAXXZ DD 025050f01H
	DD	010a230fH
	DD	07003001fH
	DD	05002H
xdata	ENDS
...
text$x	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?Print@PurlemonHazel@@YAXXZ
_TEXT	SEGMENT
tv71 = 192
?Print@PurlemonHazel@@YAXXZ PROC			; PurlemonHazel::Print, COMDAT
; File D:\Code\learn_cpp\PurlemonHazel\PurlemonHazel\src\test.cpp
; Line 6
$LN3:
	push	rbp
	push	rdi
	sub	rsp, 248				; 000000f8H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__565E8CC1_test@cpp
	call	__CheckForDebuggerJustMyCode
; Line 7
	lea	rdx, OFFSET FLAT:??_C@_0BK@CEIHGBBI@Welcome?5to?5PurlemonHazel?$CB@
...
; Line 8
	...
	pop	rbp
	ret	0
?Print@PurlemonHazel@@YAXXZ ENDP			; PurlemonHazel::Print
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
